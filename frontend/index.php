      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        <div class="col">
          <div class="card shadow-sm"> 
              <img src="/Ex05/assets/<?= $item[5] ?>" alt="<?= $item[1] ?>" class="img-fluid" style="height: 225px; object-fit: cover;"> 
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a href="/Ex05/frontend/pages/details.php?id=<?= $item[0] ?>" class="btn btn-sm btn-outline-primary">View</a>
